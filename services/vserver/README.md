...
- API version: 2026-05-08T11:26:31Z
...
*V2Api* | [**ChangeFabricClusterDescription**](docs/V2Api.md#changefabricclusterdescription) | **Post** /changeFabricClusterDescription | 
*V2Api* | [**ChangeFabricClusterName**](docs/V2Api.md#changefabricclustername) | **Post** /changeFabricClusterName | 
...
*V2Api* | [**ChangeServerInstanceName**](docs/V2Api.md#changeserverinstancename) | **Post** /changeServerInstanceName | 
...
*V2Api* | [**CreateFabricCluster**](docs/V2Api.md#createfabriccluster) | **Post** /createFabricCluster | 
...
*V2Api* | [**DeleteFabricCluster**](docs/V2Api.md#deletefabriccluster) | **Post** /deleteFabricCluster | 
...
*V2Api* | [**GetFabricClusterDetail**](docs/V2Api.md#getfabricclusterdetail) | **Post** /getFabricClusterDetail | 
...
*V2Api* | [**UpdateFabricCluster**](docs/V2Api.md#updatefabriccluster) | **Post** /updateFabricCluster | 
*V2Api* | [**UpdateFabricClusterServerInstances**](docs/V2Api.md#updatefabricclusterserverinstances) | **Post** /updateFabricClusterServerInstances | 
